...
export function BeforeAfterSection() {
  ...
  return (
    <section className="bg-black py-20 text-white lg:py-28" ref={ref}>
        ...
        <div className="grid items-stretch gap-6 lg:grid-cols-[1fr_auto_1fr]">
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-2xl font-black text-white">Without Website</h3>
            ...
            <div className="space-y-4">
              {withoutWebsite.map((item) => (
                <div key={item} className="flex items-center gap-3 rounded-xl border border-white/8 bg-black/40 p-4">
                  <XCircle className="h-5 w-5 shrink-0 text-white/35" />
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <h3 className="text-2xl font-black text-white">With SiteBano</h3>
            ...
            <div className="space-y-4">
              {withSiteBano.map((item) => (
                <div key={item} className="flex items-center gap-3 rounded-xl border border-primary/20 bg-black/40 p-4">
